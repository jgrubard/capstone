                    ...
                    <div className="row h-100">
                        <div className="col-lg-7 my-auto">
                            <div className="header-content mx-auto">
                                ...
                                <a href="#signup" className="btn btn-outline btn-xl js-scroll-trigger">Sign Up!</a>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-md-8 mx-auto">
                            ...
                            <div className="badges">
                                <a className="badge-link" href="#"><img src="img/google-play-badge.svg" alt=""></img></a>
                                <a className="badge-link" href="#"><img src="img/app-store-badge.svg" alt=""></img></a>
                            </div>
                        </div>
                    </div>
                </div>
